...
public class TektonUnits {
	...
	achlyos, //chrysaora, chronex, //,gigantea //cyanea

	//physalis, nutricula, chronex, gigantea, cephea, chrysaora (one of the big), cotylorhiza, mastigias, //jellyfish biological boss?
	...
	public static void load(){
		...
		electron = new MinionUnitType("electron") {{
            ...
            weapons.add(new Weapon(name + "-weapon") {{
                ...
                activeSound = TektonSounds.loopElectron;
                activeSoundVolume = 0.2f;
                
                continuous = alwaysContinuous = true;
                
                bullet = new PointLaserBulletType(){{
                	sprite = "tekton-electron-laser";
                    damage = 4f;
                    pierceArmor = true;
		...
		piezo = new TektonTankUnitType("piezo") {{
            ...
            weapons.add(new Weapon(name + "-weapon") {{
                ...
                ejectEffect = Fx.none;
                shootSound = TektonSounds.shootPiezo;
                shootSoundVolume = 1f;
                inaccuracy = 2;

                bullet = new LaserBoltBulletType(6f, 24f) {{
		...
		electret = new TektonTankUnitType("electret") {{
            ...
            weapons.add(new Weapon(name + "-weapon") {{
                ...
                parentizeEffects = true;
                ejectEffect = Fx.none;
                shootSound = TektonSounds.shootElectret;
		...
		discharge = new TektonTankUnitType("discharge") {{
            ...
            treadRects = new Rect[]{
            		//i understand now.
            		new Rect(15f, -53f, 32, 36), //two
            		new Rect(-16f, 22f, 32, 36) //one
            		};
		...
		supernova = new TektonTankUnitType("supernova") {{
            ...
            abilities.add(new ForceFieldAbility(140f, 120f / 60f, 3000f, 60f * 20f, 6, 0f));
            ...
            weapons.add(new Weapon(name + "-weapon") {{
                ...
                x = y = 0;
                reload = 360f;
                recoil = rotateSpeed = inaccuracy = 0f;
                rotate = false;
                heatColor = Color.valueOf("4a9eff");
                shootCone = 7f;
                autoTarget = true;
		...
		eques = new TektonUnitType("eques") {{
            ...
            moveSound = Sounds.loopExtract;
            moveSoundVolume = 0.28f;
            moveSoundPitchMin = 0.5f;
            moveSoundPitchMax = 1.2f;
			
            parts.addAll(defaultHoverPart(6.6f, 5.25f, true, 10, 1.5f, 150f), defaultHoverPart(6.65f, -5.65f, true, 12, 1.5f, 150f));
            ...
            weapons.add(new Weapon(name + "-weapon") {{
            	...
            	rotateSpeed = 0;
            	parentizeEffects = true;
            	shootSound = TektonSounds.shootEques;
		...
		phalanx = new TektonUnitType("phalanx") {{
            ...
            float delayShoot = Fx.greenLaserChargeSmall.lifetime - 1f;
            
			abilities.addAll(new SuppressionFieldAbility() {{
				range *= supressionRangeMul;
                orbRadius = 9.5f;
                y = -3.4f;
            }}, new EffectStatusEffectAbility(0, 0, Pal.sapBullet, new MultiEffect(new Effect(30f, 160f, e -> {
                color(Pal.sapBullet);
                Fx.rand.setSeed(e.id);
                for(int i = 0; i < 16; i++){
            ...
            })), 10f, TektonStatusEffects.incineration, delayShoot));
            ...
            weapons.add(new Weapon(name + "-weapon") {{
                ...
                shoot.firstShotDelay = delayShoot;
                parentizeEffects = true;
                ...
                bullet = new ContinuousFlameBulletType() {{
                    ...
                    hitEffect = new Effect(12, e -> {
                        ...
                        randLenVectors(e.id, 6, e.finpow() * 18f, (x, y) -> {
                            lineAngle(e.x + x, e.y + y, Mathf.angle(x, y), e.fout() * 4 + 1f);
                        });
                    });
                    drawSize = 0f;
                    lifetime = 160f;
                    ...
                    intervalBullet = new BasicBulletType(0, 1f) {{
                        ...
                        pierceArmor = true;
                        pierceCap = -1;
                        despawnEffect = hitEffect = shootEffect = smokeEffect = chargeEffect = Fx.none;
                        drawSize = 0f;
                        lifetime = 160f;
		...
		imperatoris = new TektonUnitType("imperatoris") {{
            ...
            moveSound = Sounds.loopExtract;
            moveSoundVolume = 2.5f;
            moveSoundPitchMin = 0.25f;
            moveSoundPitchMax = 0.7f;
            ...
            var bulletImperatoris2 = new BasicBulletType() {{
                ...
                fragBullet = intervalBullet = new BasicBulletType(2.5f, 15f){{
                    width = 9f;
                    hitSize = 5f;
                    height = 15f;
                    pierceCap = 3;
        ...
        strike = new TektonUnitType("strike") {{
            ...
            for (float ex : new float[]{-bx, 0, bx}) {
            	weapons.add(new Weapon(name + "-weapon") {{
                    ...
                    ejectEffect = Fx.none;
                    recoil = 0f;
                    shootSound = TektonSounds.shootStrike;
                    shootSoundVolume = .85f;
                    heatColor = Pal.turretHeat;
                    //velocityRnd = 0.5f;
                    inaccuracy = 15f;
                    alternate = false;
        ...
        hammer = new TektonUnitType("hammer") {{
        	...
        	weapons.add(new Weapon(name + "-weapon") {{
                ...
                shootSound = TektonSounds.shootHammer;
        ...
        impact = new TektonUnitType("impact") {{
            ...
            for (float i : new float[] {0f, 1f, 2f}) {
            	weapons.add(new DependentWeapon(name + "-weapon") {{
            		var deg = -45 * i;
                    shootSound = TektonSounds.shootImpact;
                    shootSoundVolume = 0.6f;
                    soundPitchMin = 0.9f + i * .5f;
                    soundPitchMax += i * .5f;
        ...
        earthquake = new TektonUnitType("earthquake") {{
        	...
        	abilities.add(new ArmorPlateAbility() {{ }
	            ...
	            public void addStats(Table t){
	                super.addStats(t);
	                t.row();
	                t.add(abilityStat("speedreduction", Strings.autoFixed((1f - speedMultiplier) * 100f, 1)));
	            }
            ...
            weapons.add(
                ...
                ejectEffect = Fx.none;
                chargeSound = TektonSounds.chargeEarthquake;
                shootSound = TektonSounds.shootEarthquake;
                soundPitchMin = 0.95f;
      ...
      //naval
          ...
          sagres = new TektonUnitType("sagres") {{
              ...
              weapons.add(new Weapon("tekton-mount-weapon") {{
                  ...
                  rotate = true;
                  ejectEffect = Fx.casing2;
                  shootSound = TektonSounds.shootSagres;
          ...
          argos = new TektonUnitType("argos") {{
              ...
              weapons.add(new Weapon(name + "-weapon") {{
                  ...
                  rotate = true;
                  ejectEffect = Fx.casing1;
                  shootSound = TektonSounds.shootArgos;
              	soundPitchMin = 0.95f;
      			soundPitchMax = 1.05f;
          ...
          ariete = new TektonUnitType("ariete") {{
              ...
              var missile = new MissileBulletType(4f, 10f) {{
                  lifetime = 60f;
                  homingPower = 0.2f;
                  ammoMultiplier = 2f;
              ...
              weapons.add(
                  ...
                  shootSound = TektonSounds.shootAriete;
          ...
          castelo = new TektonUnitType("castelo") {{
              ...
              weapons.add(new Weapon(name + "-weapon") {{
                ...
                ejectEffect = Fx.casing4;
              	inaccuracy = 6f;
              	shootSound = TektonSounds.shootCastelo;
              	soundPitchMin = 0.7f;
              	soundPitchMax = 0.85f;
              	shootSoundVolume = 0.6f;
				...
				cooldownTime = 80f;
                  ...
                  bullet = new BasicBulletType(10f, 100f) {{
                      collidesTiles = collides = true;
                      collidesAir = true;
                      sprite = "missile-large";
                      width = 9.5f;
                      ...
                      fragBullet = new BasicBulletType(6.5f, 15f) {{
                          sprite = "missile-large";
                          width = 8f;
                          height = 12f;
                          lifetime = 12f;
		...
		formicaEgg = new TektonBioUnitType("egg") {{
			constructor = TimedKillUnit::create;
			//hidden = true;
        ...
        amecephalus = new TektonBioUnitType("amecephalus"){{
			...
			abilities.addAll(new DeflectBulletAbility(), new MoveEffectAbility(holeX, holeY, TektonLiquids.acid.color, holeEffect, holeDelay) {{ chance = holeChance; minVelocity = minVelocityHole; }}, new MoveEffectAbility(-holeX, holeY, TektonLiquids.acid.color, holeEffect, holeDelay) {{ chance = holeChance; minVelocity = minVelocityHole; }});
			immunities.add(TektonStatusEffects.radiationAbsorption); //this creature would be too OP if it was enabled to consume radiation
			customFogRadius = true;
			fogRadius = 9f;
			health = 24000;
            ...
            canDrown = false;
            drownTimeMultiplier = 1000f;
            
            crushDamage = 10f;
            crushFragile = true;

            crawlSlowdown = 0.075f;
            crawlSlowdownFrac = 0.9f;

            drawBody = false;
            segments = 10;
            segmentRotSpeed = 0.5f;
            segmentScl = 4f;
            segmentPhase = 2f;
            segmentMag = 1f;
            ...
            weapons.add(new Weapon() {{
                ...
                bullet = new ArtilleryBulletType(3f, 10) {{
                	Color col = TektonLiquids.acid.color.cpy();
                    ...
                    backColor = hitColor = frontColor = trailColor =  col;
		...
		polyphaga = new TektonBioUnitType("polyphaga") {{
            ...
            abilities.addAll(generateDefaultWing(3f, -0.25f, 260f, 260f, -15f, name + "-wing-bottom", 91f - 0.001f, 18f));
            abilities.addAll(new SpawnDeathAbility() {{ unit = groundPolyphaga; }}, new DodgeAbility(2.8f));
		...
		lepidoptera = new TektonBioUnitType("lepidoptera") {{
            ...
            //shadowElevation = 0.1f;
            abilities.addAll(generateDefaultWing(5.5f, 4.3f, 180f, 180f, 15f, name + "-wing", 91f, 19f));
		...
		aedes = new TektonBioUnitType("aedes") {{
            ...
            //shadowElevation = 0.1f;
            abilities.addAll(generateDefaultWing(8f, 5f, 180f, 180f, 12f, name + "-wing", 91f, 24f));
            ...
            weapons.addAll(new Weapon(name + "-front") {{
                ...
                bullet = new SapBulletType(){{
                    ...
                    lightColor = hitColor = color = Color.valueOf("82d629");
                    despawnEffect = Fx.none;
                    width = 0.55f;
                    lifetime = 30f;
                    knockback = -1f;
		...
		achlyos = new TektonBioUnitType("achlyos") {{
            ...
            loopSound = TektonSounds.loopBioHover;
            loopSoundVolume = 0.065f;

            ((LiquidExplodeAbility)abilities.get(0)).liquid = TektonLiquids.ammonia;
            ((ColorDebrisAbility)abilities.get(2)).color = TektonColor.ammonia;
            abilities.add(new DrawBladesAbility());
            lightColor = healColor = TektonColor.ammonia;
            deathExplosionEffect = TektonFx.biologicalAmmoniaDynamicExplosion;
            fallEffect = new Effect(110, e -> {
                color(TektonColor.ammonia.cpy(), Pal.surge.cpy(), e.rotation);
		...
		return new MoveEffectAbility[] {
			new MoveEffectAbility() {{
	        	...
	        	effect = new MultiEffect(
	    				effecter(tbaseRotation, tspin, regionName + "-left", 0f, layer, size),
	    				effecter(baseRotationOffset, -tspin, regionName + "-left", 1f, layer, size)
	    				);
			}},
			new MoveEffectAbility() {{
	        	minVelocity = 0f;
	        	...
	        	parentizeEffects = true;
	        	effect = new MultiEffect(
	    				effecter(180f - tbaseRotation, -tspin, regionName + "-right", 0f, layer, size),
	    				effecter(180f - baseRotationOffset, tspin, regionName + "-right", 1f, layer, size)
	    				);
	        }}
		};
	}
