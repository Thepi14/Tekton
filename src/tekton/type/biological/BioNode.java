	...
	public class BioNodeBuild extends PowerNodeBuild {
        ...
        public void draw() {
            ...
            for(int i = 0; i < power.links.size; i++){
                ...
                if(!linkValid(this, link, true) || (link.block instanceof PowerNode && link.id >= id)) {
					continue;
				}
	    ...
	    public boolean linkValid(Building tile, Building link, boolean checkMaxNodes){
	        if(tile == link || link == null || !link.block.hasPower || !link.block.connectedPower || tile.team != link.team || (sameBlockConnection && tile.block != link.block)) {
				return false;
			}
