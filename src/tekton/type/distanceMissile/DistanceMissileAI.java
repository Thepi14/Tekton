...
public class DistanceMissileAI extends AIController{
    ...
    public Teamc target(float x, float y, float range, boolean air, boolean ground){
        return Units.closestTarget(unit.team, x, y, range, u -> u.checkTarget(air, ground) && !(u.type instanceof MissileUnitType) && !(u.type instanceof DistanceMissileUnitType), t -> ground && (!t.block.underBullets || (shooter != null && t == Vars.world.buildWorld(shooter.aimX, shooter.aimY))));
    }
